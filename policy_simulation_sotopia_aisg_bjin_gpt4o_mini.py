...
$env:PYTHONUTF8="1"
$env:PARALLEL_RUNS="7"
.\.venv\Scripts\python.exe sotopia/policy_simulation_sotopia_aisg_bjin_gpt4o_mini.py
=========================================================================
출력 파일:
...
RUN_OUTPUT_DIR = RESULT_DIR / "policy_simulation_sotopia_aisg_bjin_gpt4o_mini_runs"
...
def deepseek_call(
    ...
    payload = {"model": MODEL_NAME, "messages": [{"role": "system", "content": system_content}, {"role": "user", "content": user_content}], "stream": True, "temperature": 0.7}
    response = requests.post(LUXIA_API_URL, headers=headers, json=payload, stream=True, timeout=120)
