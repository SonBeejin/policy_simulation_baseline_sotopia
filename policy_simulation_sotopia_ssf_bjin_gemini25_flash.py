...
$env:PYTHONUTF8="1"
$env:PARALLEL_RUNS="5"
.\.venv\Scripts\python.exe sotopia/policy_simulation_sotopia_ssf_bjin_gemini25_flash.py
=========================================================================
출력 파일:
...
RUN_OUTPUT_DIR = RESULT_DIR / "policy_simulation_sotopia_ssf_bjin_gemini25_flash_runs"
...
def build_policy_prompt(policy_text: str) -> str:
    return (
        "We are simulating a stakeholder discussion about the input SSF "
        ...
        "the other agents.\n\n"
        f"{policy_text}\n\n"
        "Target indicator: annual_sci_e_paper_count_2021_2022. This is the "
        "annual number of SCI(E)-indexed journal papers published during "
...
class PolicyDiscussionAgent(BaseAgent[Observation, AgentAction]):
    def __init__(self, persona: dict[str, Any], policy_prompt: str) -> None:
        ...
        self._goal = (
            "Discuss SSF policy effects with the other stakeholders and provide "
            "a prediction for annual_sci_e_paper_count_2021_2022."
        )
    ...
    async def aact(self, obs: Observation) -> AgentAction:
        ...
        if self.turns_spoken == 0:
            ...
            user_prompt = (
                ...
                "and keep the conversation focused on the annual SCI(E) paper "
    ...
    async def final_prediction(self, interaction_log: list[dict[str, Any]]) -> str:
        ...
        user_prompt = (
            ...
            '{"prediction_values": {"annual_sci_e_paper_count_2021_2022": <number>}, '
...
def build_env_profile(num_agents: int) -> EnvironmentProfile:
    return EnvironmentProfile(
        codename="ssf_sci_e_publication_multi_agent_discussion",
        scenario=(
            "Multiple SSF stakeholders discuss the input policy document and "
            "predict the annual SCI(E) paper publication count for 2021-2022. "
            "Each participant speaks from their professional background and "
            "reacts to others."
        ),
        agent_goals=[
            "Provide an evidence-based estimate of "
            "annual_sci_e_paper_count_2021_2022 and respond to other stakeholders."
...
async def run_once(
    ...
    output_path = RUN_OUTPUT_DIR / (
        f"sotopia_simulation_ssf_results_run_{run_index:03d}.json"
    )
    ...
    for result in results:
        ...
        pred_val = (
            ...
            .get("annual_sci_e_paper_count_2021_2022")
        )
    ...
    return {
        ...
        "prediction_key": "annual_sci_e_paper_count_2021_2022",
