...
.\.venv\Scripts\python.exe sotopia/policy_simulation_sotopia_aisg_bjin.py
=========================================================================
출력 파일:
...
RUN_OUTPUT_DIR = RESULT_DIR / "policy_simulation_sotopia_aisg_bjin_runs"
...
def build_policy_prompt(policy_text: str) -> str:
    return (
        ...
        "the other agents.\n\n"
        f"{policy_text}\n\n"
        "Target indicator: cumulative_ai_project_completion_count_2022. "
        "This is the cumulative number of AI projects completed from 2018 "
        "through the end of 2022. The value to predict is the 2022 cumulative "
        "completed-project count.\n\n"
        "Guidance:\n"
        "- If the policy document contains an explicit completed-project "
        "count, target, or cumulative value, use that as the anchor.\n"
        "- If it does not, make a reasonable estimate from your professional "
        "background and the discussion evidence.\n"
        "- During discussion, compare assumptions about project pipeline, "
        "funding scale, implementation timeline, completion criteria, and "
        "delivery capacity.\n\n"
